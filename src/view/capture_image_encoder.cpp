...
bool isBGRA(engine::TextureFormat format) {
    return format == engine::TextureFormat::BGRA8_UNorm ||
           format == engine::TextureFormat::BGRA8_sRGB;
}
