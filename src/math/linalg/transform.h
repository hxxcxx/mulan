...
struct Transform3 {
    ...
    constexpr Transform3(const Vec3& t, const Quat& r, const Vec3& s) : translation(t), rotation(r), scale(s) {}

    /// M = Translate * Rotate * Scale
    Mat4 toMatrix() const {
        Mat4 m = Mat4::translate(translation) * rotation.toMat4() * Mat4::scale(scale);
        return m;
    }
    ...
    Mat4 toInverseMatrix() const {
        ...
        return Mat4::scale(invScale) * rotation.conjugate().toMat4() * Mat4::translate(-translation);
    }
...
struct Transform2 {
    ...
    constexpr Transform2(const Vec2& t, double r, const Vec2& s) : translation(t), rotation(r), scale(s) {}
