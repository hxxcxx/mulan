...
core::Result<TessellatedGeometry> Shape::tessellate(const TessellationOptions& opts) const {
    if (!storage_)
        return std::unexpected(core::Error::make(core::ErrorCode::InvalidArg, "tessellate on empty Shape"));
