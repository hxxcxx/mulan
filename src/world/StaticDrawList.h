...
public:
    ...
    std::span<const MeshDrawCommand> transparentCommands() const { return m_transparentCmds; }
...
private:
    ...
    std::vector<MeshDrawCommand> m_transparentCmds;
    ...
    std::unordered_map<Entity::Id, ProxyIndex> m_proxyIndex;
};
