...
float4 main(VS_OUTPUT input, bool isFrontFace : SV_IsFrontFace) : SV_TARGET {
    ...
    float3 sampled = AlbedoTex.Sample(AlbedoSampler, input.texcoord).rgb;
