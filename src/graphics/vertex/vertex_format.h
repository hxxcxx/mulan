...
template <>
struct VertexFormatTraits<VertexFormat::Float> {
    using type = float;
};
template <>
struct VertexFormatTraits<VertexFormat::UInt> {
    using type = uint32_t;
};
template <>
struct VertexFormatTraits<VertexFormat::UByte4N> {
    using type = uint32_t;
};
template <>
struct VertexFormatTraits<VertexFormat::Int> {
    using type = int32_t;
};

template <>
struct VertexFormatTraits<VertexFormat::Float2> {
    struct type {
        float x, y;
    };
};
template <>
struct VertexFormatTraits<VertexFormat::Float3> {
    struct type {
        float x, y, z;
    };
};
template <>
struct VertexFormatTraits<VertexFormat::Float4> {
    struct type {
        float x, y, z, w;
    };
};
template <>
struct VertexFormatTraits<VertexFormat::Half2> {
    struct type {
        uint16_t x, y;
    };
};
template <>
struct VertexFormatTraits<VertexFormat::Half4> {
    struct type {
        uint16_t x, y, z, w;
    };
};
template <>
struct VertexFormatTraits<VertexFormat::UInt2> {
    struct type {
        uint32_t x, y;
    };
};
template <>
struct VertexFormatTraits<VertexFormat::UInt3> {
    struct type {
        uint32_t x, y, z;
    };
};
template <>
struct VertexFormatTraits<VertexFormat::UInt4> {
    struct type {
        uint32_t x, y, z, w;
    };
};
template <>
struct VertexFormatTraits<VertexFormat::Int2> {
    struct type {
        int32_t x, y;
    };
};
template <>
struct VertexFormatTraits<VertexFormat::Int3> {
    struct type {
        int32_t x, y, z;
    };
};
template <>
struct VertexFormatTraits<VertexFormat::Int4> {
    struct type {
        int32_t x, y, z, w;
    };
};
template <>
struct VertexFormatTraits<VertexFormat::UByte4> {
    struct type {
        uint8_t x, y, z, w;
    };
};
