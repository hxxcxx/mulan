...
namespace MulanGeo::BRep::primitive {
...
inline Wire<Point3, Curve> rect(const BoundingBox2D& box, const Geometry::Plane& plane) {
...
inline Wire<Point3, Curve> circle(Point3 start, Point3 origin, Vector3 axis, size_t division) {
...
inline Solid<Point3, Curve, Surface> cuboid(const BoundingBox3D& box) {
    Point3 p = box.minPt;
    Point3 q = box.maxPt;
    ...
    // Face 0 (z = p.z, bottom) — inverted orientation
    {
...
inline Solid<Point3, Curve, Surface> cylinder(double radius, double height, Point3 origin, Vector3 axis, size_t division = 16) {
...
inline Shell<Point3, Curve, Surface> sphere(double radius, Point3 origin, size_t u_div = 16, size_t v_div = 16) {
...
inline Solid<Point3, Curve, Surface> torus(double major_radius, double minor_radius, Point3 origin, Vector3 axis, size_t u_div = 16, size_t v_div = 16) {
