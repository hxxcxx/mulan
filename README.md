...
最初的渲染相关的代码来自我去年编写的 OpenGL 学习项目
[MulanEngine](https://github.com/hxxcxx/MulanEngine)

建模方面使用 OCCT，并通过
[truck-bridge](https://github.com/hxxcxx/truck-bridge.git) 实验性接入 Rust 几何建模库 Truck。

数学模块源于我之前使用 ImGui 学习计算几何与 CAGD 时编写的
[BeyondConvex](https://github.com/hxxcxx/BeyondConvex) 和
[BeyondFlat](https://github.com/hxxcxx/BeyondFlat)。
...
- truck-bridge 通过 C ABI 将 Rust Truck 接入 C++。
- Truck 后端当前仅在 Windows 上可选启用。
- 数学模块包含 Bezier、B-Spline、NURBS 参数曲线与曲面、二维计算几何，
  以及 KD-tree、R-tree、BVH 等空间数据结构。
