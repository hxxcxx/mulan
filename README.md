...
- CMake 3.24 或更高版本
- Qt 6.8 或更高的 6.x 版本，使用 MSVC 2022 x64 构建
...
$env:QTDIR = "F:/dev/qt6/6.8.3/msvc2022_64"
...
```powershell
cmake -S . -B build/no-occt -G "Visual Studio 17 2022" -A x64 `
...
- 其余 C++ 包由 vcpkg manifest 安装，具体版本由 `vcpkg.json` 的 baseline 决定。
